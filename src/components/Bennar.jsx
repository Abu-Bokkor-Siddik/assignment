...
const Bennar = () => {
  return (
    <div>
    <div className="hero h-[600px] lg:min-h-screen" style={{backgroundImage: 'url(https://i.ibb.co/XLFKjYm/lovepik-overhead-view-of-young-people-in-study-group-image-352041216.jpg)'}}>
  <div className="hero-overlay bg-opacity-60"></div>
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      <h1 className="mb-5 text-3xl  lg:text-5xl font-bold">Hello Friends</h1>
      ...
      <button className="btn btn-outline btn-sm my-10">Get Started</button>
    </div>
  </div>
</div>
    </div>
